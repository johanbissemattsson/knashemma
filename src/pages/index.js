    ...
    <article className='index page'>
      ...
      <div className='page-sections'>
        ...
        <section>
          ...
          <div className='section-content'>
            <p>Tillsammans med olika aktörer, erbjuder vi ett samskapande för att stärka barns och ungas röster och delaktighet. Det kan handla om att ta fram nya arbetssätt för ökad delaktighet och tillgänglighet (via sociala medier), ingå i referensgrupper och projekt utifrån unga människors egna perspektiv, i statliga rapporter, ge input på textmaterial samt via våra föreläsningar och utbildningspaket för socialtjänst, på familjehemsutbildningar, på universitet och högskolor etc. Vi kommer gärna och föreläser och inspirerar er!<br /><Link to="/page/">Läs mer</Link></p>
          </div>
        </section>
        <section>
          <header className='section-header'>
          ...
          <div className='section-content'>        
            <p>Kreativa delaktighetsmetoder Knas hemma tar fram kreativa metoder för att lyfta barns och ungas delaktighet och röster inom Socialtjänst, familjehem, HVB-hem, samt andra aktörer som träffar målgruppen. Det handlar om att engagera barn och ungdomar genom att lyssna på hur de själva identifierar problem, föreslår lösningar och agera utifrån dem.<br /><Link to="/page/">Läs mer</Link></p>
          </div>
        </section>
      </div>
    </article>
